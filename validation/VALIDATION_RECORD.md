...
| `unit/test_economics.mjs` | CRF, NPV annuity, combined gross-output cost, heat-saving conversion, and demand-matched net payback | `node validation/unit/test_economics.mjs` |
