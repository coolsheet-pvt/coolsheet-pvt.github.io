...
assert.match(homePage, /Installed PVT cost \(AUD\/m&sup2;\)/);
assert.match(homePage, /entered directly in AUD\/m&sup2;/);
assert.doesNotMatch(homePage, /AUD\/ft&sup2;; non-SI/);
